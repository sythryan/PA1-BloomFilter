...
public class Debug {
	...
	public static void main(String[] args) {
		...
		System.out.println("Select Bloom Filter Type");
		...
		if (choice == 1)
		{
			...
			while (true) {		
				...
				if (choice == 1) {
					System.out.println("Enter a string element to add");
					randomFilter.add(in.nextLine());
				}
				else if (choice == 2) {
					System.out.println("Enter a string element to find");
					System.out.println(randomFilter.appears(in.nextLine()));
				}
				else if (choice == 3) {
					System.out.println("Number of hash functions needed: " + randomFilter.numHashes());
				}
				else if (choice == 4) {
					System.out.println("Filter Size: " + randomFilter.filterSize());
				}
				else if (choice == 5) {
					System.out.println("Data Size: " + randomFilter.dataSize());
				}
				else if (choice == 6) {
					break;
				}
